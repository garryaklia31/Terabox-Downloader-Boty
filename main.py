...
"""
    ...
    await m.reply(
        ...
        buttons=[
            [
                Button.url("Updates", "https://t.me/TERABOXSUPPORT01"),
...
async def handle_message(m: Message):
    ...
    if not check_if:
        return await m.reply("Please join @garryplays then send me the link again.")
    ...
    if int(data["sizebytes"]) > 1718738592 and m.sender_id not in [1718738592]:
        return await hm.edit(
...
print("This bot is deployed by @TERABOXSUPPORT01 kindly join this channel for more updates.")
